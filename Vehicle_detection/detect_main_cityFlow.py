...
if CAM == 1:
    start, end = sv.Point(x=45, y=850), sv.Point(x=831, y=396)
    attention_vector1 = [[0,250],[1279,250]], ">"
    attention_vector2 = [[920,1000],[541,0]], "<"
    cap = cv2.VideoCapture(f'/home/tomass/tomass/ReID_pipele/source_videos/AI_City_01_Itersection/vdo4.avi')
elif CAM == 2:
...
while ret:
    ...
    # -------- Drawing attention vectors ---------------

    # Draw attention_vector1
    cv2.line(display, tuple(attention_vector1[0][0]), tuple(attention_vector1[0][1]), (0, 255, 255), 2)
    cv2.putText(display, attention_vector1[1], 
                (attention_vector1[0][1][0] - 20, attention_vector1[0][1][1] - 10), 
                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)

    # Draw attention_vector2
    cv2.line(display, tuple(attention_vector2[0][0]), tuple(attention_vector2[0][1]), (0, 0, 255), 2)
    cv2.putText(display, attention_vector2[1], 
                (attention_vector2[0][1][0] - 20, attention_vector2[0][1][1] + 30), 
                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
    
    # Draw point
    cv2.circle(display, (start.x, start.y), 0, (0, 255, 0), 5)
    cv2.circle(display, (end.x, end.y), 0, (0, 255, 0), 5)
